...
<a class="reference-card" href="orders-of-magnitude.html"><span class="badge">Intuition</span><strong>Orders of Magnitude</strong><span>Frequency, wavelength, field, power, noise, time and length scales.</span></a>
<a class="reference-card" href="scaling-laws.html"><span class="badge">Scaling</span><strong>Dimensionless Numbers & Scaling</strong><span>Electrical size, far field, skin depth, Q, diffraction, Rabi/linewidth and Rydberg scaling.</span></a>
<a class="reference-card" href="comparison-tables.html"><span class="badge">Choose</span><strong>Comparison Tables</strong><span>Methods and technologies compared by strengths, limitations and “use when.”</span></a>
<a class="reference-card" href="common-misconceptions.html"><span class="badge">Correct</span><strong>Common Misconceptions</strong><span>Short corrections to persistent conceptual errors.</span></a>
<a class="reference-card" href="derivations.html"><span class="badge">Derive</span><strong>Essential Derivations</strong><span>Selected derivations where the algebra exposes useful physics.</span></a>
<a class="reference-card" href="history-timeline.html"><span class="badge">History</span><strong>History Timeline</strong><span>Coulomb → Faraday → Maxwell → Hertz → Heaviside → Rabi → modern field metrology.</span></a>
...
When you meet a new problem:

1. Identify the **physical regime** using [Scaling Laws](scaling-laws.html).
